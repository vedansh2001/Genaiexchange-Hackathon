export const QNA = [
    {
        id: 1,
        ques: `Life Insurance`,
        ans:  `Life Insurance is a financial cover for a contingency
...
is loss of income to the household.`
    ...
    {
        id: 2,
        ques: `Why you should buy Life Insurance:`,
        ans:  `All of us face the following risks:
Dying too soon
Living too long
...
needs`
    ...
    {
        id: 3,
        ques: `Who needs Life Insurance:`,
        ans:  `Primarily, anyone who has a family to support and is
an income earner needs Life Insurance. In view of
the economic value of their contribution to the
family, housewives too need life insurance cover.
Even children can be considered for life insurance in
view of their future income potential being at risk.`
    },
    {
        id: 4,
        ques: `What should I look for before I decide to buy a
policy ?`,
        ans:  `You must check and see whether or not there is
availability of guarantee of return, what the lock in
period is, details of premium to be paid, what
would be implications of premium default, what
the revival conditions are what the policy terms
are, what are the charges that would be deducted,
would loan be available etc`
    },
    {
        id: 5,
        ques: `What is the importance of a proposal and the
disclosures made therein ?`,
        ans:  `The disclosures made in a proposal are the basis for
...
claim.`
    ...
    {
        id:6,
        ques: `What are special medical reports required to be
submitted in Life insurance?`,
        ans: `In case of certain proposals, depending upon the
...
required.`
    ...
    {
        id:7,
        ques: `How is the Loan on Policy calculated under
Conventional Life Insurance Policies?`,
        ans: `If the policy conditions permit grant of loan, loan is
sanctioned as a percentage of the Surrender Value.`
    },
    {
        id:8,
        ques: `What are the requirements to be submitted in
case of a Maturity Claim?`,
        ans: `Usually the Insurance Company will send
...
the assignee who will give the discharge`
    ...
    {
        id:9,
        ques: `What is meant by settlement options?`,
        ans: `Settlement option means the facility made
...
inception of the contract).`
    ...
    {
        id:10,
        ques: `What documents are generally required to be
submitted in case of death of life assured while
the policy is in force?`,
        ans: `The basic documents that are generally required
are death certificate, claim form and policy bond,
...
policy bond.`
    ...
    {
        id:11,
        ques: `How is Surrender value calculated in Unit
Linked Policies?`,
        ans: `Surrender value is usually expressed as fund value
less the surrender charge.`
    },
    {
        id:12,
        ques: `What is a Unit Fund?`,
        ans: `The allocated (invested) portions of the premiums
...
form a Unit fund.`
    },
    {
        id:13,
        ques: `What is a Unit?`,
        ans: `It is a component of the Fund in a Unit Linked
Policy.`
    },
    {
        id:14,
        ques: `What Types of Funds do ULIP Offer?`,
        ans: `Most insurers offer a wide range of funds to suit
...
fund to fund.`
    ...
    {
        id:15,
        ques: `What are the Charges, fees and deductions in a
ULIP?`,
        ans: `ULIPs offered by different insurers have varying
...
charges over a period of time.`
    ...
    {
        id:16,
        ques: `What should one verify before signing the
proposal?`,
        ans: `One has to verify the approved sales brochure for
...
the life insurance council.`
    ...
    {
        id:17,
        ques: `How much of the premium is used to purchase
units?`,
        ans: `The full amount of premium paid is not allocated
...
varies from product to product.`
    ...
    {
        id:18,
        ques: `Can one seek refund of premiums if not satisfied
with the policy, after purchasing it?`,
        ans: `The policyholder can seek refund of premiums if he
...
premium for the period of cover.`
    ...
    {
        id:19,
        ques: `What is Net Asset Value (NAV)?`,
        ans: `NAV is the value of each unit of the fund on a given
