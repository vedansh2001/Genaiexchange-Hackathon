...
const UserProfilePage = () => {
  ...
  // Function to update form data with extracted values
  ...
  console.log("form data after extraction",formData)
  };
    ...
    <>
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-screen-xl">
          ...
          <div className="flex">
            {/* Profile Image */}
            <div className="flex flex-col mb-16 w-1/2 pl-96">
              <div className="relative">
                ...
                <label
                  ...
                  className="absolute bottom-0 left-0 bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-full cursor-pointer"
                >
            ...
            {/* Data Extractor */}
            <div>
              <DataExtractor onExtract={updateFormData} />
            </div>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4 w-full">
            ...
            <div className="col-span-2 flex justify-center">
              <button
                type="submit"
                className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg w-1/2 mt-12"
              >
                Save Profile
              </button>
            </div>
